...
/*http://doc.qt.nokia.com/4.6/qt4-network.html#tcp-client*/
	...
	//hide all the turret controls
	remoteControl.turretControlLabel->setVisible(false);
	remoteControl.turretDownButton->setVisible(false);
	remoteControl.turretUpButton->setVisible(false);
	remoteControl.turretLeftButton->setVisible(false);
	remoteControl.turretRightButton->setVisible(false);
	remoteControl.fireButton->setVisible(false);
