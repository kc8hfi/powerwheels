...
public:
    ...
    void setupUi(QMainWindow *RemoteControlBase)
    {
        ...
        RemoteControlBase->resize(369, 338);
        ...
        layoutWidget->setGeometry(QRect(50, 50, 184, 202));
        ...
        layoutWidget1->setGeometry(QRect(240, 50, 184, 232));
        ...
        gridLayout_2->addWidget(turretControlLabel, 0, 0, 1, 4);
        ...
        gridLayout_2->addWidget(turretUpButton, 1, 2, 1, 1);
        ...
        gridLayout_2->addWidget(turretRightButton, 2, 3, 1, 1);
        ...
        gridLayout_2->addWidget(turretDownButton, 3, 2, 1, 1);
        ...
        gridLayout_2->addWidget(fireButton, 4, 0, 1, 4);
